    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(299)  = dumData; %prealloc
                    ...
                    section.data(233).dtTransOffset = 260;
                    ...
                    section.data(238).dtTransOffset = 270;

                    ;% rtB.gwno0h0ad0
                    section.data(239).logicalSrcIdx = 238;
                    section.data(239).dtTransOffset = 273;
                    ...
                    section.data(241).dtTransOffset = 279;
                    ...
                    section.data(246).dtTransOffset = 286;

                    ;% rtB.btbmowyvpj
                    section.data(247).logicalSrcIdx = 246;
                    section.data(247).dtTransOffset = 289;
                    ...
                    section.data(250).dtTransOffset = 294;

                    ;% rtB.f4v0hwmwl1
                    section.data(251).logicalSrcIdx = 250;
                    section.data(251).dtTransOffset = 297;
                    ...
                    section.data(289).dtTransOffset = 337;
                    ...
                    section.data(296).dtTransOffset = 346;

                    ;% rtB.kodulhrduv
                    section.data(297).logicalSrcIdx = 296;
                    section.data(297).dtTransOffset = 349;

                    ;% rtB.a4nzpbifls
                    section.data(298).logicalSrcIdx = 297;
                    section.data(298).dtTransOffset = 352;

                    ;% rtB.nid0rlczhv
                    section.data(299).logicalSrcIdx = 298;
                    section.data(299).dtTransOffset = 355;
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% rtDW.l2yct0nspg.AQHandles
                    section.data(2).logicalSrcIdx = 3;
                    section.data(2).dtTransOffset = 1;

                    ;% rtDW.ffm5asd12k.AQHandles
    ...
    targMap.checksum0 = 722722470;
    targMap.checksum1 = 2369403267;
    targMap.checksum2 = 702987444;
    targMap.checksum3 = 3972630618;
