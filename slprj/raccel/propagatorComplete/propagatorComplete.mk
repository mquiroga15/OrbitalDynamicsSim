...
PRODUCT_NAME              = propagatorComplete
MAKEFILE                  = propagatorComplete.mk
...
COMPILER_COMMAND_FILE     = propagatorComplete_comp.rsp
CMD_FILE                  = propagatorComplete.rsp
...
PRODUCT = ./propagatorComplete.exe
...
SRCS = $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete.c $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete_capi.c $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete_data.c $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete_tgtconn.c $(START_DIR)/slprj/raccel/propagatorComplete/rtGetInf.c $(START_DIR)/slprj/raccel/propagatorComplete/rtGetNaN.c $(START_DIR)/slprj/raccel/propagatorComplete/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
%.obj : $(START_DIR)/slprj/raccel/propagatorComplete/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorComplete/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorComplete/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorComplete/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorComplete/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
propagatorComplete.obj : $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorComplete_capi.obj : $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorComplete_data.obj : $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorComplete_tgtconn.obj : $(START_DIR)/slprj/raccel/propagatorComplete/propagatorComplete_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/propagatorComplete/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/propagatorComplete/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/propagatorComplete/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
