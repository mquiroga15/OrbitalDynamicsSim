###########################################################################
## Makefile generated for component 'propagator'. 
## 
## Makefile     : propagator.mk
## Generated on : Mon Dec 11 10:59:46 2023
## Final product: ./propagator.exe
...
COMPILER_COMMAND_FILE     = propagator_comp.rsp
CMD_FILE                  = propagator.rsp
...
DEFINES_STANDARD = -DMODEL=propagator -DNUMST=2 -DNCSTATES=13 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/propagator/propagator.c $(START_DIR)/slprj/raccel/propagator/propagator_capi.c $(START_DIR)/slprj/raccel/propagator/propagator_data.c $(START_DIR)/slprj/raccel/propagator/propagator_tgtconn.c $(START_DIR)/slprj/raccel/propagator/rtGetInf.c $(START_DIR)/slprj/raccel/propagator/rtGetNaN.c $(START_DIR)/slprj/raccel/propagator/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = propagator.obj propagator_capi.obj propagator_data.obj propagator_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/propagator/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
propagator.obj : $(START_DIR)/slprj/raccel/propagator/propagator.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagator_capi.obj : $(START_DIR)/slprj/raccel/propagator/propagator_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagator_data.obj : $(START_DIR)/slprj/raccel/propagator/propagator_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagator_tgtconn.obj : $(START_DIR)/slprj/raccel/propagator/propagator_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/propagator/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/propagator/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/propagator/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
