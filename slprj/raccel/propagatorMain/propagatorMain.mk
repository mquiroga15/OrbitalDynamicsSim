###########################################################################
## Makefile generated for component 'propagatorMain'. 
## 
## Makefile     : propagatorMain.mk
## Generated on : Sun Jun 16 23:43:41 2024
## Final product: ./propagatorMain.exe
...
COMPILER_COMMAND_FILE     = propagatorMain_comp.rsp
CMD_FILE                  = propagatorMain.rsp
...
DEFINES_STANDARD = -DMODEL=propagatorMain -DNUMST=2 -DNCSTATES=15 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain.c $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain_capi.c $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain_data.c $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain_tgtconn.c $(START_DIR)/slprj/raccel/propagatorMain/rtGetInf.c $(START_DIR)/slprj/raccel/propagatorMain/rtGetNaN.c $(START_DIR)/slprj/raccel/propagatorMain/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = propagatorMain.obj propagatorMain_capi.obj propagatorMain_data.obj propagatorMain_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/propagatorMain/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorMain/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorMain/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorMain/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorMain/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
propagatorMain.obj : $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorMain_capi.obj : $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorMain_data.obj : $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorMain_tgtconn.obj : $(START_DIR)/slprj/raccel/propagatorMain/propagatorMain_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/propagatorMain/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/propagatorMain/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/propagatorMain/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
