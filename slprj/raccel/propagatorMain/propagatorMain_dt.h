...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . b5wz2e1q3r [ 0 ] ) , 0 , 0 ,
68 } , { ( char_T * ) ( & rtDW . m0s1rjpd4e [ 0 ] ) , 0 , 0 , 6 } , { (
char_T * ) ( & rtDW . ny4c53recd . AQHandles ) , 11 , 0 , 10 } , { ( char_T *
) ( & rtDW . pnk35gmy12 ) , 2 , 0 , 6 } , { ( char_T * ) ( & rtDW .
elz4cbgcbh ) , 8 , 0 , 5 } } ; static DataTypeTransitionTable rtBTransTable =
{ 5U , rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { {
( char_T * ) ( & rtP . area ) , 0 , 0 , 124 } } ; static
