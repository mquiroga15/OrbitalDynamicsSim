###########################################################################
## Makefile generated for component 'propagator_mess'. 
## 
## Makefile     : propagator_mess.mk
## Generated on : Tue Dec 12 10:26:02 2023
## Final product: ./propagator_mess.exe
...
COMPILER_COMMAND_FILE     = propagator_mess_comp.rsp
CMD_FILE                  = propagator_mess.rsp
...
DEFINES_STANDARD = -DMODEL=propagator_mess -DNUMST=2 -DNCSTATES=13 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess.c $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess_capi.c $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess_data.c $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess_tgtconn.c $(START_DIR)/slprj/raccel/propagator_mess/rtGetInf.c $(START_DIR)/slprj/raccel/propagator_mess/rtGetNaN.c $(START_DIR)/slprj/raccel/propagator_mess/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = propagator_mess.obj propagator_mess_capi.obj propagator_mess_data.obj propagator_mess_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/propagator_mess/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator_mess/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator_mess/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator_mess/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagator_mess/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
propagator_mess.obj : $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagator_mess_capi.obj : $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagator_mess_data.obj : $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagator_mess_tgtconn.obj : $(START_DIR)/slprj/raccel/propagator_mess/propagator_mess_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/propagator_mess/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/propagator_mess/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/propagator_mess/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
