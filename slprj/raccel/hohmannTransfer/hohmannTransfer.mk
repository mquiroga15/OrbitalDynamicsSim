###########################################################################
## Makefile generated for component 'hohmannTransfer'. 
## 
## Makefile     : hohmannTransfer.mk
## Generated on : Mon Dec 11 10:57:22 2023
## Final product: ./hohmannTransfer.exe
...
COMPILER_COMMAND_FILE     = hohmannTransfer_comp.rsp
CMD_FILE                  = hohmannTransfer.rsp
...
DEFINES_STANDARD = -DMODEL=hohmannTransfer -DNUMST=3 -DNCSTATES=14 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer.c $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer_capi.c $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer_data.c $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer_tgtconn.c $(START_DIR)/slprj/raccel/hohmannTransfer/rtGetInf.c $(START_DIR)/slprj/raccel/hohmannTransfer/rtGetNaN.c $(START_DIR)/slprj/raccel/hohmannTransfer/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = hohmannTransfer.obj hohmannTransfer_capi.obj hohmannTransfer_data.obj hohmannTransfer_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
hohmannTransfer.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hohmannTransfer_capi.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hohmannTransfer_data.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hohmannTransfer_tgtconn.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/hohmannTransfer_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/hohmannTransfer/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
