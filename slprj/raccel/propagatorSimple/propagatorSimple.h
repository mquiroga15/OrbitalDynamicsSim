...
real_T dclql12erk [ 3 ] ; real_T hatpfo3hlm ; real_T lyaqu2ph4w [ 3 ] ;
real_T mi1sjd5xhd [ 3 ] ; real_T axt2x3q3hy [ 3 ] ; } B ; typedef struct {
real_T h3cflltm3q [ 3 ] ; real_T f0h4bwqduk [ 3 ] ; struct { void * AQHandles
; } chu05kbpxu ; struct { void * AQHandles ; } czhwoklxpu ; struct { void *
AQHandles ; } j4pv5v0dny ; struct { void * AQHandles ; } ovdng33q0b ; struct
{ void * AQHandles ; } iwpwwackcm ; int8_T lbrqpwfmha ; int8_T mjolfyo1k3 ;
int8_T pyb2cpctgm ; boolean_T jdbvpmwjyw ; boolean_T nbxd2gjju2 ; boolean_T
...
typedef struct { real_T mry5gqeihh ; real_T hi2lkxa1hh ; real_T nvpkxxqfbb ;
...
P_ { real_T area ; real_T initMass ; real_T ref ; real_T thrust ; real_T
...
; real_T Burn_Value ; real_T Constant_Value ; real_T
Constant_Value_ln0uq0icxn ; real_T Constant_Value_pnqibv1hlu ; } ; extern
