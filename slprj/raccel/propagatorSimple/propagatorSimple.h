...
lyaqu2ph4w [ 3 ] ; real_T mi1sjd5xhd [ 3 ] ; real_T axt2x3q3hy [ 3 ] ; } B ;
typedef struct { real_T h3cflltm3q [ 3 ] ; real_T f0h4bwqduk [ 3 ] ; struct {
void * AQHandles ; } chu05kbpxu ; struct { void * AQHandles ; } czhwoklxpu ;
struct { void * AQHandles ; } j4pv5v0dny ; struct { void * AQHandles ; }
ovdng33q0b ; struct { void * AQHandles ; } iwpwwackcm ; int8_T oqf0svuwls ;
int8_T lbrqpwfmha ; int8_T mjolfyo1k3 ; int8_T pyb2cpctgm ; boolean_T
jdbvpmwjyw ; boolean_T ah5wpklf0e ; boolean_T nbxd2gjju2 ; boolean_T
irz00m5icq ; boolean_T mojmy2zhqz ; } DW ; typedef struct { real_T fay2cpmqpg
[ 13 ] ; } X ; typedef struct { real_T fay2cpmqpg [ 13 ] ; } XDot ; typedef
struct { boolean_T fay2cpmqpg [ 13 ] ; } XDis ; typedef struct { real_T
fay2cpmqpg [ 13 ] ; } CStateAbsTol ; typedef struct { real_T fay2cpmqpg [ 13
] ; } CXPtMin ; typedef struct { real_T fay2cpmqpg [ 13 ] ; } CXPtMax ;
typedef struct { real_T cxmntq42lq ; real_T mry5gqeihh ; real_T hi2lkxa1hh ;
real_T nvpkxxqfbb ; } ZCV ; typedef struct { real_T hs1awvyyae [ 3 ] ; real_T
ecbpwue5ri [ 3 ] ; real_T dtc4ufbswj [ 4 ] ; real_T prj3orfldf ; real_T
fdj51o4wpi [ 3 ] ; } ExtY ; typedef struct { rtwCAPI_ModelMappingInfo mmi ; }
DataMapInfo ; struct P_ { real_T area ; real_T burnOverride ; real_T initMass
; real_T ref ; real_T thrust ; real_T thrustingThreshold ; real_T
NormalizeVector_maxzero ; real_T NormalizeVector_maxzero_pntl1pmm30 ; real_T
NormalizeVector_maxzero_afn2dyubdl ; real_T SpacecraftDynamics_startDate ;
real_T SpacecraftDynamics_mass ; real_T SpacecraftDynamics_emptyMass ; real_T
...
Constant_Value_pnqibv1hlu ; } ; extern const char_T *
