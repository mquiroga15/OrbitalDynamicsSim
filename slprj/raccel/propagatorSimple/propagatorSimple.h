...
dl1iix2aol [ 3 ] ; real_T cm2sh5gwjs ; real_T idx0fxvvk3 ; real_T mi1sjd5xhd
[ 3 ] ; real_T axt2x3q3hy [ 3 ] ; } B ; typedef struct { real_T h3cflltm3q [
3 ] ; real_T f0h4bwqduk [ 3 ] ; struct { void * AQHandles ; } chu05kbpxu ;
struct { void * AQHandles ; } czhwoklxpu ; struct { void * AQHandles ; }
j4pv5v0dny ; struct { void * AQHandles ; } ovdng33q0b ; struct { void *
AQHandles ; } iwpwwackcm ; int8_T lbrqpwfmha ; int8_T mjolfyo1k3 ; boolean_T
jdbvpmwjyw ; boolean_T nbxd2gjju2 ; boolean_T irz00m5icq ; } DW ; typedef
struct { real_T fay2cpmqpg [ 13 ] ; } X ; typedef struct { real_T fay2cpmqpg
[ 13 ] ; } XDot ; typedef struct { boolean_T fay2cpmqpg [ 13 ] ; } XDis ;
typedef struct { real_T fay2cpmqpg [ 13 ] ; } CStateAbsTol ; typedef struct {
real_T fay2cpmqpg [ 13 ] ; } CXPtMin ; typedef struct { real_T fay2cpmqpg [
13 ] ; } CXPtMax ; typedef struct { real_T mry5gqeihh ; real_T hi2lkxa1hh ; }
...
P_ { real_T area ; real_T ref ; real_T NormalizeVector_maxzero ; real_T
NormalizeVector_maxzero_pntl1pmm30 ; real_T SpacecraftDynamics_startDate ;
...
; real_T Constant_Value ; real_T Constant_Value_ln0uq0icxn ; } ; extern const
