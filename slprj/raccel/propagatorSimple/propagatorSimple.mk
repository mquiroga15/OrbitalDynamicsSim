###########################################################################
## Makefile generated for component 'propagatorSimple'. 
## 
## Makefile     : propagatorSimple.mk
## Generated on : Tue Jan 30 13:03:41 2024
## Final product: ./propagatorSimple.exe
...
COMPILER_COMMAND_FILE     = propagatorSimple_comp.rsp
CMD_FILE                  = propagatorSimple.rsp
...
DEFINES_STANDARD = -DMODEL=propagatorSimple -DNUMST=2 -DNCSTATES=13 -DHAVESTDIO
...
OBJS = propagatorSimple.obj propagatorSimple_capi.obj propagatorSimple_data.obj propagatorSimple_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/propagatorSimple/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorSimple/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorSimple/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorSimple/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/propagatorSimple/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
propagatorSimple.obj : $(START_DIR)/slprj/raccel/propagatorSimple/propagatorSimple.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorSimple_capi.obj : $(START_DIR)/slprj/raccel/propagatorSimple/propagatorSimple_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorSimple_data.obj : $(START_DIR)/slprj/raccel/propagatorSimple/propagatorSimple_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


propagatorSimple_tgtconn.obj : $(START_DIR)/slprj/raccel/propagatorSimple/propagatorSimple_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/propagatorSimple/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/propagatorSimple/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/propagatorSimple/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
